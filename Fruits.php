    	...
    	<div class="container">
    		...
    		<div class="row">
    			<div class="col-md-6 col-lg-3 ftco-animate">
    				<div class="product">
    					<a href="#" class="img-prod"><img class="img-fluid" src="images/Avacado.jpg" alt="Avacado Fruit">
    						<span class="status">10%</span>
    						<div class="overlay"></div>
    					</a>
    					<div class="text py-3 pb-4 px-3 text-center">
    						<h3><a href="#">Avacado-1kg</a></h3>
    						<div class="d-flex">
    							<div class="pricing">
		    						<p class="price"><span class="mr-2 price-dc">Rs200.00</span><span class="price-sale">Rs150.00</span></p>
		    					</div>
	    					</div>
	    					<div class="bottom-area d-flex px-3">
	    						<div class="m-auto d-flex">
	    							...
	    							<a href="wishlist.html" class="heart d-flex justify-content-center align-items-center ">
