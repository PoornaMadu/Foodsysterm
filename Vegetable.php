...
$sql = "SELECT * FROM products where qty>0 AND cat_id=1";
$vegeproducts[] = array();
$result = $conn->query($sql);
if ($result->num_rows > 0) {
	while ($row = $result->fetch_assoc()) {
		array_push($vegeproducts, $row);
	}
}
?>
	...
	<section class="ftco-section">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-10 mb-5 text-center">
					<ul class="product-category">
						...
						<li><a href="Vegetable.php" class="active">Vegetables</a></li>
			...
			<div class="row">
				...
				<?php foreach ($vegeproducts as $key => $value) {
					if (empty($value)) continue;
					if ($value['qty'] == 0) continue;
				?>
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="product">
							<a href="#" class="img-prod"><img class="img-fluid" style="width:300px;height:300px;object-fit:cover;" src="images/<?php echo $value['img']; ?>" alt="image">
