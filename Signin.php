...
require 'Php/connection.php';
	...
	if ($row>0) {
		...
		$sql = "INSERT INTO users (user_name, user_email, user_password,user_cPassword	) VALUES ('$username','$email','$password','$confirm_password')";
		if(mysqli_query($conn, $sql)){
			header('location:http://localhost/FInalProject/Loging.php');
		}
		else{
