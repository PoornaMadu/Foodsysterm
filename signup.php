...
<body>
	<div class="signup-form">
		...
		<div class="text-center">Already have an account? <a href="Loging.php">Login here</a></div>
	</div>
...
<script>
	function checkpwd() {
		...
		if (!re.test(document.getElementById("pwd").value)) {
			document.getElementById("err").innerHTML = "Password should contain at least 6 characters";
